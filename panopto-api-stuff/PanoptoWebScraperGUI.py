...
class UI:
    def __init__(self):
        ...
        self.__widgets = []
        self.__fonts = [('Bree Serif', 30, 'bold', 'underline'), ('Bree Serif', 30, 'bold'),
                        ('Bree Serif', 30), ('Bree Serif', 20)]
        ...
        self.__place_widget(Button(self.__window, text="GO!", font=self.__fonts[1], command=self.__run,
                                   bg=self.__altCol),
                            200, 200, 900, 280)
        self.__place_widget(Label(self.__window, text="Part of the anaLecture software suite", font=self.__fonts[3],
                                  bg=self.__bgCol),
                            470, 50, 150, 670)
        self.__img = ImageTk.PhotoImage(Image.open("analecture.png").resize((150, 150), Image.BICUBIC))
